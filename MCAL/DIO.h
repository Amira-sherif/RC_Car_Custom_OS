...
void DIO_EnablePortInterrupt(DIO_PORT_et, DIO_PORT_INTERRUPT_NUM_et, DIO_BIT_et, DIO_PORT_INTERRUPT_SENSE_et, DIO_PORT_INTERRUPT_EDGE_et, DIO_PORT_INTERRUPT_EVENT_et);

// function to enable port specific pins level interrupt
void DIO_PortLevelInterrupt(DIO_PORT_et, DIO_BIT_et, DIO_PORT_INTERRUPT_EVENT_et);

// function to enable port specific pins edge interrupt
void DIO_PortEdgeInterrupt(DIO_PORT_et, DIO_BIT_et, DIO_PORT_INTERRUPT_EDGE_et, DIO_PORT_INTERRUPT_EVENT_et);
